...
export const BannerInfo = () => {
  return (
    <div className=' absolute w-full h-screen justify-center text-left md:mt-[-640px] mt-[-700px] md:px-[90px] px-[10px] flex flex-col text-white'>
              ...
              <div className='text-white md:mt-24 mt- '>
